(function ($) {
    ...
    items.click(function () {
        console.log($('.stories div').scrollLeft());
    ...
    $(window).scroll(function () {
        ...
        /*test scroll*/
        var storyActive = $('.stories div.story.active');
        console.log(storyActive.length);
        if (storyActive.length > 0) {
            $('.stories div').scrollLeft($('.stories div.story.active')[0].offsetLeft - $(window).width() / 2)
        }
        /*test scroll end*/
