...
function App() {
  ...
  /*incase too many top nav*/
  const getScroll = () => {
    return (
      <div className='stories'>
        <HorizontalScroll className="scroll" reverseScroll={true}>
          <a className='story' id='arice' href="#" onClick={setValue}>11</a>
          <a className='story' id='anoodle' href="#" onClick={setValue}>22</a>
          <a className='story' id='aporridge' href="#" onClick={setValue}>33</a>
          <a className='story' id='aporridge' href="#" onClick={setValue}>33</a>
          <a className='story' id='aporridge' href="#" onClick={setValue}>33</a>
          <a className='story' id='aporridge' href="#" onClick={setValue}>33</a>
          <a className='story' id='aporridge' href="#" onClick={setValue}>33</a>
