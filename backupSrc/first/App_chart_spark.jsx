...
function App() {
  ...
  return <ChartComponent id='charts' primaryXAxis={{ interval: 1, valueType: 'Category' }} primaryYAxis={{ title: 'Expense', minimum: 0, maximum: 500, interval: 50, labelFormat: '${value}' }}>
    <Inject services={[StackingLineSeries, Legend, Tooltip, DataLabel, Category]} />
    <SeriesCollectionDirective>
      <SeriesDirective dataSource={data} xName='x' yName='y' name='Jan' width='2' type='StackingLine' marker={{ visible: true }} dashArray='5,1'>
      </SeriesDirective>
      <SeriesDirective dataSource={data} xName='x' yName='y1' name='Feb' width='2' type='StackingLine' marker={{ visible: true }} dashArray='5,1'>
      </SeriesDirective>
      <SeriesDirective dataSource={data} xName='x' yName='y2' name='Mar' width='2' type='StackingLine' marker={{ visible: true }} dashArray='5,1'>
      </SeriesDirective>
      <SeriesDirective dataSource={data} xName='x' yName='y3' name='Apr' width='2' type='StackingLine' marker={{ visible: true }} dashArray='5,1'>
      </SeriesDirective>
    </SeriesCollectionDirective>
  </ChartComponent>;
}
